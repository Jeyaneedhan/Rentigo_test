...
class AutoPaginate
{
    ...
    /**
     * Paginate a single list using a custom page query parameter.
     */
    public static function paginate($items, $pageParam = 'page', $perPage = 10)
    {
    ...
    /**
     * Render pagination using a custom page parameter and extra query params.
     */
    public static function renderWithParam($pagination, $pageParam = 'page', $extraParams = [])
    {
        if (!is_array($pagination) || ($pagination['total'] ?? 0) <= 1) {
            return '';
        }
        ...
        $buildUrl = function ($page) use ($baseUrl, $pageParam, $extraParams) {
            $params = array_merge($_GET, $extraParams, [$pageParam => $page]);
        ...
        <div class="pagination-section">
            ...
            <nav class="pagination-nav" aria-label="Pagination Navigation">
                <ul class="pagination-buttons">
                    <?php if ($current > 1): ?>
                        <li>
                            <a href="<?php echo $buildUrl(1); ?>" class="pagination-btn first-btn" title="Go to first page">
                                <i class="fas fa-step-backward"></i> First
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo $buildUrl($current - 1); ?>" class="pagination-btn prev-btn" title="Go to previous page">
                    ...
                    if ($start > 1): ?>
                        <li>
                            <a href="<?php echo $buildUrl(1); ?>" class="pagination-btn number-btn">1</a>
                        </li>
                        <?php if ($start > 2): ?>
                            <li>
                    ...
                    <?php for ($i = $start; $i <= $end; $i++): ?>
                        <li>
                            ...
                            <?php else: ?>
                                <a href="<?php echo $buildUrl($i); ?>" class="pagination-btn number-btn">
                                    <?php echo $i; ?>
                                </a>
                            <?php endif; ?>
                        </li>
                    ...
                    <?php if ($end < $total): ?>
                        ...
                        <?php endif; ?>
                        <li>
                            <a href="<?php echo $buildUrl($total); ?>" class="pagination-btn number-btn">
                                <?php echo $total; ?>
                            </a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if ($current < $total): ?>
                        <li>
                            <a href="<?php echo $buildUrl($current + 1); ?>" class="pagination-btn next-btn" title="Go to next page">
                                Next <i class="fas fa-chevron-right"></i>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo $buildUrl($total); ?>" class="pagination-btn last-btn" title="Go to last page">
