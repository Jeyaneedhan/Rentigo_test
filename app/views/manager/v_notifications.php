...
<div class="stats-grid">
    <div class="stat-card" data-stat-type="notif_total">
        ...
        <div class="stat-content">
            <div class="stat-header">
                <h3 class="stat-label" id="stat-label-notif_total" onclick="toggleStatDropdown('notif_total')">Total Notifications</h3>
    ...
    <div class="stat-card warning" data-stat-type="notif_unread">
        ...
        <div class="stat-content">
            <div class="stat-header">
                <h3 class="stat-label" id="stat-label-notif_unread" onclick="toggleStatDropdown('notif_unread')">Unread</h3>
    ...
    <div class="stat-card success" data-stat-type="notif_read">
        ...
        <div class="stat-content">
            <div class="stat-header">
                <h3 class="stat-label" id="stat-label-notif_read" onclick="toggleStatDropdown('notif_read')">Read</h3>
    ...
    <div class="card-body">
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <span>You'll receive notifications here about property assignments, maintenance, inspections, and more.</span>
            </div>
        <?php endif; ?>
    </div>
</div>
