    ...
    <div class="stats-container">
        <div class="stat-card stat-success">
            ...
            <div class="stat-details">
                <span class="stat-number">Rs <?php echo number_format($data['totalIncome'] * 1.10 ?? 0, 0); ?></span>
                <span class="stat-label">Total Collected (with fees)</span>
            </div>
        </div>
        ...
        <div class="stat-card stat-warning">
            ...
            <div class="stat-details">
                ...
                <small>Rs <?php echo number_format($data['pendingAmount'] * 1.10 ?? 0, 0); ?> due</small>
            </div>
        </div>
        <div class="stat-card stat-primary">
            ...
            <div class="stat-details">
                <span class="stat-number"><?php echo $data['propertyCount'] ?? 0; ?></span>
