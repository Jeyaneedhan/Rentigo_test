...
<div class="page-content">
    ...
    <div class="dashboard-section">
        ...
        <div class="stats-grid">
            <div class="stat-card" data-stat-type="tenant_reviews_written">
                <div class="stat-icon">
                    <i class="fas fa-star"></i>
                </div>
                <div class="stat-info">
                    <div class="stat-header">
                        <span class="stat-label-clickable" id="stat-label-tenant_reviews_written" onclick="toggleStatDropdown('tenant_reviews_written')">Reviews Written</span>
                        <div class="stat-dropdown" id="stat-dropdown-tenant_reviews_written">
                            <div class="stat-dropdown-item selected" data-period="all" onclick="selectStatPeriod('tenant_reviews_written', 'all', event)">All Time</div>
                            <div class="stat-dropdown-item" data-period="year" onclick="selectStatPeriod('tenant_reviews_written', 'year', event)">This Year</div>
                            <div class="stat-dropdown-item" data-period="month" onclick="selectStatPeriod('tenant_reviews_written', 'month', event)">This Month</div>
                        </div>
                    </div>
                    <h3 class="stat-number" id="stat-value-tenant_reviews_written"><?php echo $data['reviewStats']->review_count ?? 0; ?></h3>
                    <span class="stat-subtext" id="stat-subtitle-tenant_reviews_written">Reviews submitted</span>
                </div>
            </div>

            <div class="stat-card" data-stat-type="tenant_avg_rating_given">
                <div class="stat-icon">
                    <i class="fas fa-chart-line"></i>
                </div>
                <div class="stat-info">
                    <div class="stat-header">
                        <span class="stat-label-clickable" id="stat-label-tenant_avg_rating_given" onclick="toggleStatDropdown('tenant_avg_rating_given')">Average Rating Given</span>
                        <div class="stat-dropdown" id="stat-dropdown-tenant_avg_rating_given">
                            <div class="stat-dropdown-item selected" data-period="all" onclick="selectStatPeriod('tenant_avg_rating_given', 'all', event)">All Time</div>
                            <div class="stat-dropdown-item" data-period="year" onclick="selectStatPeriod('tenant_avg_rating_given', 'year', event)">This Year</div>
                            <div class="stat-dropdown-item" data-period="month" onclick="selectStatPeriod('tenant_avg_rating_given', 'month', event)">This Month</div>
                        </div>
                    </div>
                    <h3 class="stat-number" id="stat-value-tenant_avg_rating_given">
                        <?php echo number_format($data['reviewStats']->avg_rating ?? 0, 1); ?>
                    </h3>
                    <span class="stat-subtext" id="stat-subtitle-tenant_avg_rating_given">Average rating given</span>
                </div>
            </div>
