...
<div class="terms-container">
            ...
            <?php if (!empty($data['policy']->policy_description)): ?>
                <div style="background: #f3f4f6; padding: 1.5rem; border-radius: 0.5rem; margin-bottom: 2rem; border-left: 4px solid #45a9ea;">
                    <p style="margin: 0; color: #374151;">
                        <i class="fas fa-info-circle" style="color: #45a9ea;"></i>
    ...
    <?php else: ?>
        <div class="no-policy-message">
            ...
            <h2>Terms of Service Not Available</h2>
            <p>Our Terms of Service policy is currently being updated. Please check back later.</p>
        </div>
    <?php endif; ?>
</div>
