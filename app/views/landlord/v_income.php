...
<div class="stats-grid">
    <div class="stat-card success" data-stat-type="income_total">
        <div class="stat-icon">
            <i class="fas fa-dollar-sign"></i>
        </div>
        <div class="stat-content">
            <div class="stat-header">
                <span class="stat-label" id="stat-label-income_total" onclick="toggleStatDropdown('income_total')">Total Income</span>
                <div class="stat-dropdown" id="stat-dropdown-income_total">
                    <div class="stat-dropdown-item selected" data-period="all" onclick="selectStatPeriod('income_total', 'all', event)">All Time</div>
                    <div class="stat-dropdown-item" data-period="year" onclick="selectStatPeriod('income_total', 'year', event)">Current Year</div>
                    <div class="stat-dropdown-item" data-period="month" onclick="selectStatPeriod('income_total', 'month', event)">Current Month</div>
                </div>
            </div>
            <div class="stat-value" id="stat-value-income_total">LKR <?php echo number_format($data['totalIncome'] ?? 0, 0); ?></div>
            <div class="stat-change" id="stat-subtitle-income_total">All time earnings</div>
        </div>
    </div>
    ...
    <div class="stat-card warning" data-stat-type="income_maintenance">
        <div class="stat-icon">
            <i class="fas fa-tools"></i>
        </div>
        <div class="stat-content">
            <div class="stat-header">
                <span class="stat-label" id="stat-label-income_maintenance" onclick="toggleStatDropdown('income_maintenance')">Maintenance Costs</span>
                <div class="stat-dropdown" id="stat-dropdown-income_maintenance">
                    <div class="stat-dropdown-item selected" data-period="all" onclick="selectStatPeriod('income_maintenance', 'all', event)">All Time</div>
                    <div class="stat-dropdown-item" data-period="year" onclick="selectStatPeriod('income_maintenance', 'year', event)">Current Year</div>
                    <div class="stat-dropdown-item" data-period="month" onclick="selectStatPeriod('income_maintenance', 'month', event)">Current Month</div>
                </div>
            </div>
            <div class="stat-value" id="stat-value-income_maintenance">
                LKR <?php
                    echo number_format(
            ...
            <div class="stat-change" id="stat-subtitle-income_maintenance">Total expenses</div>
        </div>
    </div>
    <div class="stat-card" data-stat-type="income_net">
        <div class="stat-icon">
            <i class="fas fa-chart-line"></i>
        </div>
        <div class="stat-content">
            <div class="stat-header">
                <span class="stat-label" id="stat-label-income_net" onclick="toggleStatDropdown('income_net')">Net Income</span>
                <div class="stat-dropdown" id="stat-dropdown-income_net">
                    <div class="stat-dropdown-item selected" data-period="all" onclick="selectStatPeriod('income_net', 'all', event)">All Time</div>
                    <div class="stat-dropdown-item" data-period="year" onclick="selectStatPeriod('income_net', 'year', event)">Current Year</div>
                    <div class="stat-dropdown-item" data-period="month" onclick="selectStatPeriod('income_net', 'month', event)">Current Month</div>
                </div>
            </div>
            <div class="stat-value" id="stat-value-income_net">
                LKR <?php
            ...
            <div class="stat-change" id="stat-subtitle-income_net">After expenses (All time)</div>
        </div>
    </div>
</div>
